...
export default function IncomesPage() {
  ...
  const openCreate = () => { setEditing(null); setForm({ propertyId: null, amount: null, description: '', incomeDate: new Date().toISOString().slice(0, 10), incomeType: 'RENT', paymentMethod: 'TRANSFER' }); setModalOpen(true); };
  ...
  const save = async () => {
    ...
    if (editing) await incomeApi.update(editing.id, data);
